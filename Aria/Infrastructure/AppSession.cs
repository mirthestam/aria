    ...
    IConnectionProfileProvider connectionProfileProvider) : IAppSession
{
    ...
    {
        // This automatically loads to the first connection profile known if one exists.
        // TODO: As soon as the connection provider supports this, connect to the one that is marked as 'default'.
