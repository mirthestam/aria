    ...
    public override IEnumerable<Diagnostic> Inspect(IReadOnlyList<Tag> tags)
    {
        ...
        if (!albumArtists.Any())
        {
            yield return new Diagnostic(
                ...
                "Album artist is essential for proper organization and grouping of tracks within an album. It enables Aria to correctly identify and display all tracks from the same album together, even when individual track artists differ."
            );
        }
    }
}
